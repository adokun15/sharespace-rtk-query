...
export default function RequestReceivedTable() {
  ...
  return (
    <>
      ...
      <Card elClass="w-full overflow-x-auto relative space-y-6">
        <div className="flex justify-between items-center px-4">
          <article className="space-y-2">
            <h2 className="text-2xl font-sans_serif font-bold">
              Roommate Requests
            </h2>
            <p className="text-slate-400 font-poppins">
              Accepted requests will be added to chat list, declined requests
       ...
       */}
        ...
        {(!requests || requests?.length < 1) && (
          <p className="text-xl font-poppins text-center text-muted">
            No Request Yet {`;)`}
          </p>
        )}
      </Card>
